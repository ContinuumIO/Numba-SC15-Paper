...
is using LLVM.  Both claim to support the full range of features Python
offers.

Compared to those efforts, Numba is a much more opportunistic and opinionated
project.  It focusses on a narrow subset of Python's usecases on which it
